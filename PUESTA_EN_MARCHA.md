...
| Archivo | Uso | Formato |
|---------|-----|---------|
| **`arm_system/servo_config_legacy.json`** | Interfaz web, modo autónomo, `ControladorServo` | Pulsos µs, posición 0…1, `tiempo_max_*`, hombro/codo/muñeca/pinza en canales **0–3** (mapeo clásico del proyecto) |
...
| 3.3 | Probar **parada de emergencia** en la web y conocer el comportamiento (servos apagados / stepper deshabilitado según implementación) |
| 3.4 | Primera vez: movimientos **lentos**, velocidad autónoma conservadora (`VELOCIDAD_AUTONOMA` en `config_sistema.py`) |
| 3.5 | Cableado revisado: I2C PCA9685, GPIO stepper, CSI cámara — según [CONEXIONES.md](CONEXIONES.md) |
